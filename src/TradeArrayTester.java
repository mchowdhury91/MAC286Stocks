...
public class TradeArrayTester {
	...
	public static void main(String[] args) throws ParseException{
		...
		Trade trade = new Trade(1, 391f, entryDate, 291f, exitDate, stopLoss, target, Direction.SHORT, "GOOGL");
		...
		Trade trade2 = new Trade(1, 391f, entryDate, 291f, exitDate, stopLoss, target, Direction.LONG, "GOOGL");
		System.out.println();
		...
		Trade trade3 = new Trade(10, 200f, entryDate, 391f, exitDate, stopLoss, target, Direction.LONG, "GOOGL");
		System.out.println();
		...
		for(int i = 0; i < 100; i++){
			...
			Trade t = new Trade(numShares, entryP, tEntryDate, exitP, tExitDate, stopLoss, target, dir, "GOOGL");
			tA2.add(t);
		}
